    ...
    public partial class FileForm : Form
    {
        ...
        private void Browsebutton_Click(object sender, EventArgs e)
        {
           ...
           // int intEALfromDB = 0;
            //string strLine;
            //int lCnt = 0;
            dgvagentException.Rows.Clear();
            dgvgrwtException.Rows.Clear();
            dgvNotinYard.Rows.Clear();
            dgvPODException.Rows.Clear();
            dgvStatusException.Rows.Clear();
           ...
           if (opendialog.ShowDialog() == DialogResult.OK)
           {
                   ...
                   if (txtFilePath.Text != "")
                   {
                   //using (StreamReader reader = new StreamReader(txtFilePath.Text.Trim()))
                   ...
                   //            dataGridView.Rows.Add(lines[1], lines[2], lines[3], lines[4], lines[5], lines[9]);
                   ...
                   //            dRow["POD"] = lines[5].ToString().Trim();
                   ...
                   //            if (dv.Count == 0)
                   //            {
                   //                dataGridViewCommon.Rows.Add(lines[1], lines[2], lines[3], lines[4], lines[5], lines[9]);
                   //                lblNotinYardCount.Text = dataGridViewCommon.Rows.Count.ToString();
                   //            }
                   ...
                   //        {
                   //            string[] lines = Regex.Split(strLine, ",");
                   //            lblVesRefVal.Text = lines[3].ToString();//get the last value in the first line
                   ...
                   //        if (dvYard.Count == 0)
                   //        {
                   //            //dgNotinEAL.Rows.Add(lines[1], lines[2], lines[3], lines[4], lines[5], lines[9]);
                   //            dgNotinEAL.Rows.Add(ds.Tables[0].Rows[lint1][0], ds.Tables[0].Rows[lint1][1], ds.Tables[0].Rows[lint1][2], ds.Tables[0].Rows[lint1][3], ds.Tables[0].Rows[lint1][4], ds.Tables[0].Rows[lint1][5]);
                   //        }
                   //    }
                   //}
                   //catch
        ...
        private void showreport()
        {
              ...
              //set database login information 27
            ...
            crystalReportViewer1.SelectionFormula = "{ct_deschdr.discid} =" + Convert.ToInt16( discid); 
                    ...
                    if (lCnt != 0)
                    {
                        ...
                        else if (dv.Count == 1)
                        {
                            ...
                            if (dv1.Count == 0)
                            {
                                ...
                                dRow1["Agent"] = lines[9].ToString().Trim();
                                //dRow1["POD"] = lines[5].ToString().Trim();
                                dRow1["ValinEAL"] = lines[5].ToString().Trim();
                                dRow1["ValinN4"] = pod;
                                dRow1["Description"] = "4";
                                TblCommon.Rows.Add(dRow1);
                            }
        ...
        public void getDataForEAL()
        {
            ...
            //    "vsmst.name vesselname,eqptyp.id iso,HAZARDOUS, UN_NUM haznumber  from " +
            //    "system.inv_unit unt, sYSTEM.INV_UNIT_FCY_VISIT vst,SYSTEM.ARGO_CARRIER_VISIT carr,SYSTEM.REF_BIZUNIT_SCOPED lin,SYSTEM.REF_ROUTING_POINT rout , " +
                ...
                while ((strLine1 = reader.ReadLine()) != null)
                {
                    ...
                    if (lCnt1 != 0)
                    {
                        ...
                        if (dv.Count != 0)
                        {
                            ...
                            if (dv1.Count != 0 && dv2.Count != 0 && dv3.Count != 0 && dv4.Count != 0 && dv5.Count!=0&&N4hza.ToString()==EALhza.ToString() )
                            {
