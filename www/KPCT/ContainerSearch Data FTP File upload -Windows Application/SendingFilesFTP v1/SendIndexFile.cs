...
{
    public partial class SendIndexFile : Form
    {
        string ftpServerIP;
        string ftpUserID;
        string ftpPassword;
        ...
        int i = 0;
        int j = 0;
        public SendIndexFile()
        {
            InitializeComponent();
        }

        private void SendIndexFile_Load(object sender, EventArgs e)
        {
            ftpServerIP = "www.krishnapatnamport.com";
            ftpUserID = "ctfetch1@krishnapatnamport.com";
            ftpPassword = "kpct123$";
            ftpfoldername = "ContainerSearch";
            FileName = @"E:\ContainerSearch\index.php";//ContainerList.xls
        }

        private void btnStart_Click(object sender, EventArgs e)
        {
            btnStart.Enabled = false;
            if (System.IO.File.Exists("E:\\ContainerSearch\\index.php"))//ContainerList.xls
            {               
                Upload(FileName);
            }
        }
            ...
            try
            {
                if (System.IO.File.Exists("E:\\ContainerSearch\\index.php"))//ContainerList.xls
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        MessageBox.Show("FAILED: INDEX FILE IS NOT UPLOADED DUE TO SOME TECHNICAL PROBLEMS");
