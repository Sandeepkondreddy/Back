...
namespace CS_RFID3_Host_Sample1
{
    public static class Class_ProperityLayer
    {
        ...
        //public static readonly string SqlConn_String_Internal = "Data Source=172.168.1.133;Initial Catalog=RFID;User ID=sandeep;Password=san789;";
        //public static readonly string SqlConn_String = "Data Source=172.168.1.44;Initial Catalog=RFID;User ID=sandeep;Password=san789;";
        ...
        public static string Version = "V1.5";//04.08.2015 reduce duplicate ittrations//"V1.4";//06.04.2014 reduce duplicate ittrations in tag reading //"V1.3";//03-09-2014
