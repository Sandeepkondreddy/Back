...
namespace CS_RFID3_Host_Sample1
{
	...
	{
        public static readonly string AntenaSet1_Loc = ConfigurationSettings.AppSettings["AntenaSet1Loc"];
        public static readonly string AntenaSet2_Loc = ConfigurationSettings.AppSettings["AntenaSet2Loc"];
        public static readonly string Reader_IP = ConfigurationSettings.AppSettings["ReaderIPAddress"];
        public static readonly string Reader_Port = ConfigurationSettings.AppSettings["ReaderPort"];
        public static string AntenaSet1_OldTag;
        public static string AntenaSet2_OldTag;
        ...
        public static int AntenaSet1Loc_RedLight_GPIO_PortNo = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet1Loc_RedLight_GPIO_PortNo"]);
        public static int AntenaSet1Loc_GreenLight_GPIO_PortNo = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet1Loc_GreenLight_GPIO_PortNo"]);
        ...
        public static int AntenaSet1Loc_BoomBarrier_IP = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet1Loc_BoomBarrier_IP"]);

        public static int AntenaSet2Loc_RedLight_GPIO_PortNo = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet2Loc_RedLight_GPIO_PortNo"]);
        public static int AntenaSet2Loc_GreenLight_GPIO_PortNo = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet2Loc_GreenLight_GPIO_PortNo"]);
        ...
        public static int AntenaSet2Loc_BoomBarrier_IP = Convert.ToInt32(ConfigurationSettings.AppSettings["AntenaSet2Loc_BoomBarrier_IP"]);
    }
}
